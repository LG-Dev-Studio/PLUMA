		...
		return array(
			...
			'textos'               => array(
				...
				'sondaCapacidades'   => array(
					...
					'leyenda'             => __( 'Medición del transporte que se usaría si un futuro rol necesitara ONNX embebido. NLI y RRK ya no dependen de esto — son pure-PHP, siempre disponibles.', 'pluma-engine' ),
