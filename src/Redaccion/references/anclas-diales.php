 ...
 *
 * Nivel Tres Q.1 (Etapa 8, Porción 10): "los catálogos de ejemplos-ancla son
 * artefactos localizados, no traducidos" — el arreglo se indexa primero por
 * `Periodista::$localeEditorial`, luego por dial. Un cliché natural en un
 * registro puede sonar traducido en otro, así que cada locale se cura de
 * forma independiente, nunca se genera por traducción automática de un
 * catálogo maestro. `'es-ES'` es el único locale poblado hoy (el mismo
 * registro que ya existía antes de esta porción, movido bajo su clave).
 *
